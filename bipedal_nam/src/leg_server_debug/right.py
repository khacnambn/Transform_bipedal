...
# Configure logging
logging.basicConfig(
    level=logging.INFO, format="%(asctime)s - %(levelname)s - [MCU_SERVER_RIGHT] - %(message)s"
)
...
# # Load calibration
# # ==============================
with open("/home/mobile1/Transform_bipedal/bipedal_nam/src/leg_server/calibfull.json", "r") as f:
    calib = json.load(f)
